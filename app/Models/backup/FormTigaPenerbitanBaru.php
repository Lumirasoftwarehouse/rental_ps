...
class FormTigaPenerbitanBaru extends Model
{
    use HasFactory;
    ...
    protected $fillable = [
        ...
        "status",
        "catatan_revisi",
        "form_dua_penerbitan_baru_id",
    ];

    // Relasi ke formDua
    public function formDua()
    {
        return $this->belongsTo(FormDuaPenerbitanBaru::class, 'form_dua_penerbitan_baru_id');
    }

    // Relasi ke formEmpat
    public function formEmpat()
    {
        return $this->hasOne(FormEmpatPenerbitanBaru::class, 'form_tiga_penerbitan_baru_id');
    }
}
