...
return new class extends Migration
{
    ...
    {
        Schema::create('form_tiga_penerbitan_barus', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('form_dua_penerbitan_baru_id')->constrained('form_dua_penerbitan_barus')->onDelete('cascade')->onUpdate('cascade');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('form_tiga_penerbitan_barus');
    }
};
