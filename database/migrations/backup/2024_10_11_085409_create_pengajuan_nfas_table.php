...
return new class extends Migration
{
    ...
    {
        Schema::create('pengajuan_nfas', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('fk_pic_perusahaan_nfa_id')->constrained('users')->onDelete('cascade')->onUpdate('cascade');
            $table->foreignId('fk_pic_intelud_nfa_id')->nullable()->constrained('users')->onDelete('cascade')->onUpdate('cascade');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('pengajuan_nfas');
    }
};
