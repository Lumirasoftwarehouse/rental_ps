...
return new class extends Migration
{
    ...
    {
        Schema::create('form_dua_perpanjangans', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('form_satu_perpanjangan_id')->constrained('form_satu_perpanjangans')->onDelete('cascade')->onUpdate('cascade');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('form_dua_perpanjangans');
    }
};
